...
for n in range(len(nodeSet_parall_x_y1_z0)):
    x0=node[nodeSet_parall_x_y0_z0[n]-1].coordinates[0]
    y0=node[nodeSet_parall_x_y0_z0[n]-1].coordinates[1]
    z0=node[nodeSet_parall_x_y0_z0[n]-1].coordinates[2]
    r.Set(nodes=node[nodeSet_parall_x_y0_z0[n]-1:nodeSet_parall_x_y0_z0[n]],name='Set-parall_x-0-'+str(n+1))
    mindistance=sqrt((xmin-xmax)**2+(ymin-ymax)**2+(zmin-zmax)**2)*2
    index=0
    for j in range(len(nodeSet_parall_x_y1_z0)):
        x1=node[nodeSet_parall_x_y1_z0[j]-1].coordinates[0]
        y1=node[nodeSet_parall_x_y1_z0[j]-1].coordinates[1]
        z1=node[nodeSet_parall_x_y1_z0[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_x_y1_z0[index]-1:nodeSet_parall_x_y1_z0[index]],name='Set-parall_x-10-'+str(n+1))
    ...
    for j in range(len(nodeSet_parall_x_y0_z1)):
        x1=node[nodeSet_parall_x_y0_z1[j]-1].coordinates[0]
        y1=node[nodeSet_parall_x_y0_z1[j]-1].coordinates[1]
        z1=node[nodeSet_parall_x_y0_z1[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_x_y0_z1[index]-1:nodeSet_parall_x_y0_z1[index]],name='Set-parall_x-01-'+str(n+1))
    m.Equation(name='Eq-P_X_01-U-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),1),(-1,'Ref-XZ',1),(-1,'Set-parall_x-01-'+str(n+1),1)))
    m.Equation(name='Eq-P_X_01-V-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),2),(-1,'Ref-YZ',2),(-1,'Set-parall_x-01-'+str(n+1),2)))
    #m.Equation(name='Eq-P_X_01-W-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-parall_x-01-'+str(n+1),3)))
    ...
    #m.Equation(name='Eq-P_X_11-U-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),1),(-1,'Ref-XY',1),(-1,'Ref-XZ',1),(-1,'Set-parall_x-11-'+str(n+1),1)))
    #m.Equation(name='Eq-P_X_11-V-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Ref-YZ',2),(-1,'Set-parall_x-11-'+str(n+1),2)))
    #m.Equation(name='Eq-P_X_11-W-'+str(n+1),terms=((1,'Set-parall_x-0-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-parall_x-11-'+str(n+1),3)))
'''
# For edges parallel to the y-axis
for n in range(len(nodeSet_parall_y_x1_z0)):
    x0=node[nodeSet_parall_y_x0_z0[n]-1].coordinates[0]
    y0=node[nodeSet_parall_y_x0_z0[n]-1].coordinates[1]
    z0=node[nodeSet_parall_y_x0_z0[n]-1].coordinates[2]
    r.Set(nodes=node[nodeSet_parall_y_x0_z0[n]-1:nodeSet_parall_y_x0_z0[n]],name='Set-parall_y-0-'+str(n+1))
    mindistance=sqrt((xmin-xmax)**2+(ymin-ymax)**2+(zmin-zmax)**2)*2
    index=0
    for j in range(len(nodeSet_parall_y_x1_z0)):
        x1=node[nodeSet_parall_y_x1_z0[j]-1].coordinates[0]
        y1=node[nodeSet_parall_y_x1_z0[j]-1].coordinates[1]
        z1=node[nodeSet_parall_y_x1_z0[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_y_x1_z0[index]-1:nodeSet_parall_y_x1_z0[index]],name='Set-parall_y-10-'+str(n+1))
    ...
    for j in range(len(nodeSet_parall_y_x0_z1)):
        x1=node[nodeSet_parall_y_x0_z1[j]-1].coordinates[0]
        y1=node[nodeSet_parall_y_x0_z1[j]-1].coordinates[1]
        z1=node[nodeSet_parall_y_x0_z1[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_y_x0_z1[index]-1:nodeSet_parall_y_x0_z1[index]],name='Set-parall_y-01-'+str(n+1))
    m.Equation(name='Eq-P_y_01-U-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),1),(-1,'Ref-XZ',1),(-1,'Set-parall_y-01-'+str(n+1),1)))
    m.Equation(name='Eq-P_y_01-V-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),2),(-1,'Ref-YZ',2),(-1,'Set-parall_y-01-'+str(n+1),2)))
    m.Equation(name='Eq-P_y_01-W-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-parall_y-01-'+str(n+1),3)))
    ...
    m.Equation(name='Eq-P_y_11-U-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),1),(-1,'Ref-X',1),(-1,'Ref-XZ',1),(-1,'Set-parall_y-11-'+str(n+1),1)))
    m.Equation(name='Eq-P_y_11-V-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),2),(-1,'Ref-YZ',2),(-1,'Ref-YZ',2),(-1,'Set-parall_y-11-'+str(n+1),2)))
    m.Equation(name='Eq-P_y_11-W-'+str(n+1),terms=((1,'Set-parall_y-0-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-parall_y-11-'+str(n+1),3)))

# For edges parallel to the z-axis
for n in range(len(nodeSet_parall_z_x1_y0)):
    x0=node[nodeSet_parall_z_x0_y0[n]-1].coordinates[0]
    y0=node[nodeSet_parall_z_x0_y0[n]-1].coordinates[1]
    z0=node[nodeSet_parall_z_x0_y0[n]-1].coordinates[2]
    r.Set(nodes=node[nodeSet_parall_z_x0_y0[n]-1:nodeSet_parall_z_x0_y0[n]],name='Set-parall_z-0-'+str(n+1))
    mindistance=sqrt((xmin-xmax)**2+(ymin-ymax)**2+(zmin-zmax)**2)*2
    index=0
    for j in range(len(nodeSet_parall_z_x1_y0)):
        x1=node[nodeSet_parall_z_x1_y0[j]-1].coordinates[0]
        y1=node[nodeSet_parall_z_x1_y0[j]-1].coordinates[1]
        z1=node[nodeSet_parall_z_x1_y0[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_z_x1_y0[index]-1:nodeSet_parall_z_x1_y0[index]],name='Set-parall_z-10-'+str(n+1))
    ...
    for j in range(len(nodeSet_parall_z_x0_y1)):
        x1=node[nodeSet_parall_z_x0_y1[j]-1].coordinates[0]
        y1=node[nodeSet_parall_z_x0_y1[j]-1].coordinates[1]
        z1=node[nodeSet_parall_z_x0_y1[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_parall_z_x0_y1[index]-1:nodeSet_parall_z_x0_y1[index]],name='Set-parall_z-01-'+str(n+1))
    m.Equation(name='Eq-P_z_01-U-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),1),(-1,'Ref-XY',1),(-1,'Set-parall_z-01-'+str(n+1),1)))
    m.Equation(name='Eq-P_z_01-V-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Set-parall_z-01-'+str(n+1),2)))
    m.Equation(name='Eq-P_z_01-W-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),3),(-1,'Set-parall_z-01-'+str(n+1),3)))
    ...
    m.Equation(name='Eq-P_z_11-U-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),1),(-1,'Ref-X',1),(-1,'Ref-XY',1),(-1,'Set-parall_z-11-'+str(n+1),1)))
    m.Equation(name='Eq-P_z_11-V-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Set-parall_z-11-'+str(n+1),2)))
    m.Equation(name='Eq-P_z_11-W-'+str(n+1),terms=((1,'Set-parall_z-0-'+str(n+1),3),(-1,'Set-parall_z-11-'+str(n+1),3)))
...
for n in range(len(nodeSet_vertice_x0_y0_z0)):
    ...
    m.Equation(name='Eq-V_100-U-'+str(n+1),terms=((1,'Set-vertice_100-'+str(n+1),1),(-1,'Ref-X',1),(-1,'Set-vertice_100-'+str(n+1),1)))
    m.Equation(name='Eq-V_100-V-'+str(n+1),terms=((1,'Set-vertice_100-'+str(n+1),2),(-1,'Set-vertice_100-'+str(n+1),2)))
    m.Equation(name='Eq-V_100-W-'+str(n+1),terms=((1,'Set-vertice_100-'+str(n+1),3),(-1,'Set-vertice_100-'+str(n+1),3)))
    ...
    m.Equation(name='Eq-V_010-U-'+str(n+1),terms=((1,'Set-vertice_010-'+str(n+1),1),(-1,'Ref-XY',1),(-1,'Set-vertice_010-'+str(n+1),1)))
    m.Equation(name='Eq-V_010-V-'+str(n+1),terms=((1,'Set-vertice_010-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Set-vertice_010-'+str(n+1),2)))
    m.Equation(name='Eq-V_010-W-'+str(n+1),terms=((1,'Set-vertice_010-'+str(n+1),3),(-1,'Set-vertice_010-'+str(n+1),3)))
    for j in range(len(nodeSet_vertice_x1_y1_z0)):
        x1=node[nodeSet_vertice_x1_y1_z0[j]-1].coordinates[0]
        y1=node[nodeSet_vertice_x1_y1_z0[j]-1].coordinates[1]
        z1=node[nodeSet_vertice_x1_y1_z0[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_vertice_x1_y1_z0[index]-1:nodeSet_vertice_x1_y1_z0[index]],name='Set-vertice_110-'+str(n+1))
    m.Equation(name='Eq-V_110-U-'+str(n+1),terms=((1,'Set-vertice_110-'+str(n+1),1),(-1,'Ref-Y',1),(-1,'Ref-XY',1),(-1,'Set-vertice_110-'+str(n+1),1)))
    m.Equation(name='Eq-V_110-V-'+str(n+1),terms=((1,'Set-vertice_110-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Set-vertice_110-'+str(n+1),2)))
    m.Equation(name='Eq-V_110-W-'+str(n+1),terms=((1,'Set-vertice_110-'+str(n+1),3),(-1,'Set-vertice_110-'+str(n+1),3)))
    ...
    m.Equation(name='Eq-V_001-U-'+str(n+1),terms=((1,'Set-vertice_001-'+str(n+1),1),(-1,'Ref-XZ',1),(-1,'Set-vertice_001-'+str(n+1),1)))
    m.Equation(name='Eq-V_001-V-'+str(n+1),terms=((1,'Set-vertice_001-'+str(n+1),2),(-1,'Ref-YZ',2),(-1,'Set-vertice_001-'+str(n+1),2)))
    m.Equation(name='Eq-V_001-W-'+str(n+1),terms=((1,'Set-vertice_001-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-vertice_001-'+str(n+1),3)))
    for j in range(len(nodeSet_vertice_x1_y0_z1)):
        x1=node[nodeSet_vertice_x1_y0_z1[j]-1].coordinates[0]
        y1=node[nodeSet_vertice_x1_y0_z1[j]-1].coordinates[1]
        z1=node[nodeSet_vertice_x1_y0_z1[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_vertice_x1_y0_z1[index]-1:nodeSet_vertice_x1_y0_z1[index]],name='Set-vertice_101-'+str(n+1))
    m.Equation(name='Eq-V_101-U-'+str(n+1),terms=((1,'Set-vertice_101-'+str(n+1),1),(-1,'Ref-X',1),(-1,'Ref-XZ',1),(-1,'Set-vertice_101-'+str(n+1),1)))
    m.Equation(name='Eq-V_101-V-'+str(n+1),terms=((1,'Set-vertice_101-'+str(n+1),2),(-1,'Ref-YZ',2),(-1,'Set-vertice_101-'+str(n+1),2)))
    m.Equation(name='Eq-V_101-W-'+str(n+1),terms=((1,'Set-vertice_101-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-vertice_101-'+str(n+1),3)))
    ...
    m.Equation(name='Eq-V_011-U-'+str(n+1),terms=((1,'Set-vertice_011-'+str(n+1),1),(-1,'Ref-XY',1),(-1,'Ref-XZ',1),(-1,'Set-vertice_011-'+str(n+1),1)))
    m.Equation(name='Eq-V_011-V-'+str(n+1),terms=((1,'Set-vertice_011-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Ref-YZ',2),(-1,'Set-vertice_011-'+str(n+1),2)))
    m.Equation(name='Eq-V_011-W-'+str(n+1),terms=((1,'Set-vertice_011-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-vertice_011-'+str(n+1),3)))
    for j in range(len(nodeSet_vertice_x1_y1_z1)):
        x1=node[nodeSet_vertice_x1_y1_z1[j]-1].coordinates[0]
        y1=node[nodeSet_vertice_x1_y1_z1[j]-1].coordinates[1]
        z1=node[nodeSet_vertice_x1_y1_z1[j]-1].coordinates[2]
        distance=sqrt((x0-x1)**2+(y0-y1)**2+(z0-z1)**2)
        if (distance < mindistance):
            mindistance=distance
            index=j
    r.Set(nodes=node[nodeSet_vertice_x1_y1_z1[index]-1:nodeSet_vertice_x1_y1_z1[index]],name='Set-vertice_111-'+str(n+1))
    m.Equation(name='Eq-V_111-U-'+str(n+1),terms=((1,'Set-vertice_111-'+str(n+1),1),(-1,'Ref-X',1),(-1,'Ref-XY',1),(-1,'Ref-XZ',1),(-1,'Set-vertice_111-'+str(n+1),1)))
    m.Equation(name='Eq-V_111-V-'+str(n+1),terms=((1,'Set-vertice_111-'+str(n+1),2),(-1,'Ref-Y',2),(-1,'Ref-YZ',2),(-1,'Set-vertice_111-'+str(n+1),2)))
    m.Equation(name='Eq-V_111-W-'+str(n+1),terms=((1,'Set-vertice_111-'+str(n+1),3),(-1,'Ref-Z',3),(-1,'Set-vertice_111-'+str(n+1),3)))
'''
